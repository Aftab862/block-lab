...
import Logo from "@assets/img/logo/blockLab.svg";
              ...
              <div className="col-xxl-6 col-xl-8">
                <div className="tp-header-top-info">
                  <ul>
                    ...
                    <li>
                      <a href="mailto:blocklab@support.com">
                        <span>
                          <i className="fa-solid fa-envelope"></i>
                        </span>
                        blocklab@support.com
                      </a>
                    </li>
              ...
              <div className="row gx-0 align-items-center">
                <div className="col-xxl-3 col-xl-3">
                  <div className="tp-header-main-left d-flex align-items-center p-relative">
                    ...
                    <div className="tp-header-logo">
                      <Link href="/">
                        <Image src={Logo} alt="theme-pure" width={200} />
                      </Link>
                    </div>
                  </div>
                </div>
                <div className="col-xxl-6 col-xl-6 d-none d-xl-block">
                  <div className="tp-main-menu-area counter d-flex align-items-center">
                    <div className="tp-main-menu mx-auto menu-icon">
